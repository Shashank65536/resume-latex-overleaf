...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Used the Spring Boot framework to develop microservices for a product which facilitates copy trading, while "Feign Client" managed intercommunication.}
        \resumeItem{Created a Search Engine that uses ElasticSearch to allow users to search all types of stocks.}
        \resumeItem{Provided multi brokerage support with the help of Microservice architecture.}
        \resumeItem{Integrated Paytm wallet for payment administration.}
